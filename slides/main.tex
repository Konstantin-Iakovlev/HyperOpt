...
\begin{frame}{Аппроксимация гиперградиента}
  ...
  \begin{tikzpicture}
    ...
    \node at (-2, -4.7) [rectangle, draw] (hyp) {$d_{\vect{\alpha}}\lval(\vect{w}_T, \vect{\alpha};\gamma)$};
