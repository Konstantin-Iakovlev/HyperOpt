...
class CNN(hk.Module):
    def __init__(self, num_classes=10):
        ...
        self.conv1 = hk.Conv2D(output_channels=8, kernel_shape=3)
        self.conv2 = hk.Conv2D(output_channels=8, kernel_shape=3)
        self.conv3 = hk.Conv2D(output_channels=8, kernel_shape=3)
