...
class CNN(hk.Module):
    def __init__(self, num_classes=10, channels=128):
        ...
        self.conv1 = hk.Conv2D(output_channels=channels, kernel_shape=(3,3), with_bias=True)
        self.bn1 = hk.BatchNorm(True, True, 0.9)
        self.conv2 = hk.Conv2D(output_channels=channels, kernel_shape=(3,3), with_bias=True)
        self.bn2 = hk.BatchNorm(True, True, 0.9)
        self.conv3 = hk.Conv2D(output_channels=channels, kernel_shape=(3,3), with_bias=True)
